...
public class ChartFragment extends BaseFragment {
    ...
    public static ChartFragment newInstance(List<Region> regions){
    ...
    protected void populate() {
        tvRegion=find(R.id.fragment_chart_tv_title);
    ...
    private void displayPieChart() {
        ...
        dataSet.setColors(Color.GREEN,Color.RED,Color.MAGENTA,Color.DKGRAY,Color.LTGRAY,Color.CYAN,
                Color.BLACK,Color.GRAY,Color.WHITE,Color.BLUE,Color.YELLOW,Color.TRANSPARENT);
    ...
    private void initCharts() {
        ...
        barProgram=find(R.id.fragment_chart_bar_program);
        barStation=find(R.id.fragment_chart_bar_station);
